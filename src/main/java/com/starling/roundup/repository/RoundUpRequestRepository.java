...
public interface RoundUpRequestRepository extends JpaRepository<RoundUpRequest, String> {
    ...
    boolean existsByAccountIdAndWeekCommencingAndStatus(String accountId, LocalDate weekCommencing, RoundUpStatus status);
    ...
    void updateStatusAndAmountByAccountAndWeek(String accountId, LocalDate weekCommencing, RoundUpStatus status, long amount);
}
